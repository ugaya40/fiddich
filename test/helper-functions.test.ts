...
describe('Helper functions', () => {
  describe('Nullable helpers', () => {
    ...
    it('should create nullable computed', () => {
      ...
      const selectedUserComputed = createNullableComputed(({ get }) => {
  ...
  describe('Complex nullable/optional patterns', () => {
    ...
    it('should combine nullable and optional patterns', () => {
      ...
      const itemsComputed = createOptionalComputed(({ get }) => get(apiResponseCell)?.data?.items);

      // Extract error - can be undefined
      const errorComputed = createOptionalComputed(({ get }) => get(apiResponseCell)?.error);
