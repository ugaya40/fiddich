...
import { createCell, createComputed, atomicUpdate, get, pending } from '../src';
import type { State } from '../src';
import { wait, createControllablePromise, initialize, createDiamondDependency, createComputedChain } from './test-helpers';
...
describe('Pending functionality', () => {
  ...
  describe('Complex pending scenarios', () => {
    ...
    it('should work with nested atomicUpdate', async () => {
      ...
      await atomicUpdate(async (outerOps) => {
        ...
        let innerPromise: Promise<any> | undefined;
  ...
  describe('Error handling', () => {
    it('should continue clearing pending even if finally handler throws', async () => {
      ...
      promise.finally = function(onFinally: any) {
  ...
  describe('Performance considerations', () => {
    ...
    it('should avoid duplicate work when visiting same state multiple times', () => {
      ...
      const trackVisits = (state: State<any>) => {
