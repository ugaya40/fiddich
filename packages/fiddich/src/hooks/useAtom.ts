...
export const useNearestAtom = <T>(atom: Atom<T> | AtomFamily<T>, option?: LimitedAtomOption<T>): [T, AtomSetterOrUpdater<T>] => {
  return useAtom(atom, { ...option, place: { type: 'nearest' } });
};
